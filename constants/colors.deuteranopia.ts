...
const colorsDeuteranopia = {
  light: {
    ...
    ResultadoAsistencia: {
      ...
      previewBlockBg: '#e3f2fd',
      previewTitle: '#2B6CB0',
      excelContainerBorder: '#4299E1',
      excelContainerBg: '#e3f2fd',
      tablaBorder: '#4299E1',
      tablaBg: '#fff',
      tablaHeaderText: '#2B6CB0',
      tablaCellText: '#1A202C',
...
export default colorsDeuteranopia;